...
function TelaListaTipo() {
  const inputGen = useRef();
  const [generico, setGenerico] = useState("/tipos");
  ...
  const handlerPesquisar = (e) => {
    if (inputGen.current.value) {
      setGenerico("/tipos/nome/" + inputGen.current.value);
    } else {
      setGenerico("/tipos");
    }
  };
  ...
  return (
    <section className="componentesList">
      <div className="barraFiltroGenerico">
        <Form.Label className="NomeGenericoLabel">Nome do Tipo</Form.Label>
        <Form.Control
          className="campoNomeGenericoFiltro"
          ref={inputGen}
          size="sm"
          type="text"
          placeholder={"Insira Tipo"}
        />
        ...
        <div>
          <div className="btnListTable">
            <Button
              ...
              href={"/editartipos/tipos/undefined"}
            >
              Incluir
            </Button>
            <Button
              ...
              href={"/editartipos/tipos/" + idgenerico}
            >
              Alterar
            </Button>
          </div>
