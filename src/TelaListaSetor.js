...
function TelaListaSetor() {
  const inputGen = useRef();
  const [generico, setGenerico] = useState("/setores");
  ...
  const handlerPesquisar = (e) => {
    if (inputGen.current.value) {
      setGenerico("/setores/nome/" + inputGen.current.value);
    } else {
      setGenerico("/setores");
    }
  };
  ...
  return (
    <section className="componentesList">
      <div className="barraFiltroGenerico">
        <Form.Label className="NomeGenericoLabel">Nome do Setor</Form.Label>
        <Form.Control
        ...
        <div>
          <div className="btnListTable">
            <Button
              ...
              href={"/editarsetores/setores/undefined"}
            >
              Incluir
            </Button>
            <Button
              ...
              href={"/editarsetores/setores/" + idgenerico}
            >
              Alterar
            </Button>
          </div>
